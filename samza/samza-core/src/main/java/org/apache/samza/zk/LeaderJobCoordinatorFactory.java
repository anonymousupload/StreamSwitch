...
public class LeaderJobCoordinatorFactory implements JobCoordinatorFactory {
    private static final Logger LOG = LoggerFactory.getLogger(LeaderJobCoordinatorFactory.class);
    ...
    public JobCoordinator getJobCoordinator(Config config) {
        ...
        return new LeaderJobCoordinator(config, metricsRegistry, zkUtils);
    }
